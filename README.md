...
3. **순수 한국인 원문 리뷰 실시간 추출 & 텍스트 정화**:
   ...
   - 비디오 타임스탬프(`0:03`), 사진 수(`+15`), UI 버튼(`"자세히 보기"`, `"좋아요"`), 선택 옵션 태그(`"식사 유형…"` 등) 노이즈 완전 제거
